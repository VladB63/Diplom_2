...
class TestOrder:
    ...
    def test_create_order_in_auth_with_ingrit(self):
        usm = UsersMethods()
        om = OrderMethods()
        usm.create_users()
        usm.log_user()
    ...
    def test_create_order_in_auth_not_ingrit(self):
        usm = UsersMethods()
        om = OrderMethods()
        usm.create_users()
        usm.log_user()
    ...
    def test_create_order_in_correct_ingrit(self, ingrit):
        usm = UsersMethods()
        om = OrderMethods()
        usm.create_users()
        usm.log_user()
    ...
    def test_giv_order_list_with_auth(self):
        usm = UsersMethods()
        om = OrderMethods()
        usm.create_users()
